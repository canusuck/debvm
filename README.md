...
- В скрипте obfuscater.sh измените строку VBOXDIR="/home/user/sources", а точнее имя пользователя "user" на свое и конечную папку скрипта, в мооем случае он скаичвается в папку sources.
